  ...
  public class StringExpression : SmartGenerateHandlerBase
  {
    ...
    protected override void GetItems(SmartGenerateParameters smartGenerateParameters)
    {
      ...
      while (expression != null)
      {
        ...
        if (typeName == "string")
        {
          this.AddAction("Surround with 'string.IsNullOrEmpty'", "3D13FE3E-7004-42B0-B205-2881C5ADBAD2", Util.Conversion.TreeTextRangeToTextRange(expression.GetTreeTextRange()), new string[0]);
          return;
        }
