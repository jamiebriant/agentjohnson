...
namespace AgentJohnson.Statements
{
  ...
  [ContextAction(Description = "Converts an abstract class to a normal class with virtual members.", Name = "Make abstract class virtual [Agent Johnson]", Priority = -1, Group = "C#")]
