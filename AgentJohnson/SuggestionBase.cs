...
namespace AgentJohnson
{
  ...
  /// <summary>Base suggestion for Agent Johnson suggestions.</summary>
  public abstract class SuggestionBase : IHighlighting
  {
    ...
    /// <summary>
    /// Gets the color on gutter for this highlighting
    ...
    /// <summary>
    /// Gets a value indicating whether the tooltip message should be shown in the status bar when the cursor is over the highlighting
    /// </summary>
    /// <value>
    /// <c>true</c> if [show tool tip in status bar]; otherwise, <c>false</c>.
    /// </value>
    ...
    /// <summary>
    /// Gets a message for this highlighting to show in tooltip and in status bar
    /// </summary>
    /// <value></value>
    ...
    /// </summary>
    /// <value>Returns the navigation offset patch.</value>
    ...
    /// </summary>
    /// <value>Returns the tooltip.</value>
