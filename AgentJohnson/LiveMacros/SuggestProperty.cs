...
namespace AgentJohnson.LiveMacros
{
  ...
  public class SuggestProperty : IMacro
  {
    ...
    /// <returns>List of lookup items to show in order of preference. That is,</returns>
    public HotspotItems GetLookupItems(IHotspotContext context, IList<string> arguments)
    {
      return null;
    }

    /// <summary><para>Placeholder value is inserted into the text on the very initial step of template expansion
    /// and is needed for proper template text reformatting when real values cannot be calculated yet.</para>
    /// <para>More precisely, the following steps are performed:
    /// <list type="bullet">
    /// <item>
    /// placeholder values for all template fields are inserted into the text</item>
